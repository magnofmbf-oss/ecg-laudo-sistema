...
import { calcularFC, calcularIntervalo, calcularQTc, calcularEixo } from '../utils/formatters';
    ...
    <section className="card">
      ...
      <div className="measures-grid">
        ...
        <div className="measure-field calculated-field">
          <label>QTc <span className="calc-badge">Bazett</span></label>
        ...
        <div className="measure-field calculated-field">
          <label>Eixo <span className="calc-badge">Auto</span></label>
          <div className="measure-input-group">
            <input
              type="text"
              value={medidas.eixo}
      ...
      <div className="calc-info">
        ...
        <span>Clique em □ para calcular por quadrados pequenos.  FC = 1500/quadrados.  Intervalos = quadrados × 40ms.  Eixo calculado automaticamente via D1 e aVF.</span>
      </div>
    </section>
  );
};
